...
class ImageTypeFilterType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """ImageTypeFilterType."""
...
class ReferrersSyncStatus(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The status of syncing referrers. Valid values are 'Enabled' or 'Disabled'."""
