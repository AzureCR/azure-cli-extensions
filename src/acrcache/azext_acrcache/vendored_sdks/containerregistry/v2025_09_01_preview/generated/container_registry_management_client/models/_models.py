...
class CacheRulePropertiesAutoGenerated(_serialization.Model):
    ...
    :vartype provisioning_state: str or
     ~container_registry_management_client.models.ProvisioningState
    :ivar sync_mode: The sync mode. Known values are: "passiveSync" and "activeSync".
    :vartype sync_mode: str or ~container_registry_management_client.models.SyncMode
    :ivar sync_referrers: The status of syncing referrers. Valid values are 'Enabled' or
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword sync_mode: The sync mode. Known values are: "passiveSync" and "activeSync".
        :paramtype sync_mode: str or ~container_registry_management_client.models.SyncMode
        :keyword sync_referrers: The status of syncing referrers. Valid values are 'Enabled' or
         'Disabled'. Known values are: "disabled" and "enabled".
...
class CacheRuleSyncParameters(_serialization.Model):
    """The parameters for syncing a cache rule. For example, this is used to sync a specific tag from
    an upstream repository during artifact sync.

    :ivar tag_name: The name of the tag that needs to be sync'd.
    :vartype tag_name: str
    :ivar sync_tag_if_deleted: Flag to indicate whether the tag should be sync'd if it has already
     been deleted.
    :vartype sync_tag_if_deleted: bool
    """

    _attribute_map = {
        "tag_name": {"key": "tagName", "type": "str"},
        "sync_tag_if_deleted": {"key": "syncTagIfDeleted", "type": "bool"},
    }

    def __init__(
        self, *, tag_name: Optional[str] = None, sync_tag_if_deleted: Optional[bool] = None, **kwargs: Any
    ) -> None:
        """
        :keyword tag_name: The name of the tag that needs to be sync'd.
        :paramtype tag_name: str
        :keyword sync_tag_if_deleted: Flag to indicate whether the tag should be sync'd if it has
         already been deleted.
        :paramtype sync_tag_if_deleted: bool
        """
        super().__init__(**kwargs)
        self.tag_name = tag_name
        self.sync_tag_if_deleted = sync_tag_if_deleted
...
class CacheRuleUpdateParameters(_serialization.Model):
    ...
    def __init__(
        ...
        *,
        identity: Optional["_models.IdentityProperties"] = None,
        properties: Optional["_models.CacheRuleUpdateParametersProperties"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword identity: Managed identity for the resource.
...
class ImageTypeFilter(_serialization.Model):
    ...
    :ivar type: Known values are: "include" and "exclude".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword type: Known values are: "include" and "exclude".
