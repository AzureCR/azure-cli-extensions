    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "archiveVersionName": _SERIALIZER.url(
            "archive_version_name", archive_version_name, "str", max_length=200, min_length=5, pattern=r"^[a-zA-Z0-9]*$"
        ),
    }
...
def build_registries_check_cache_rule_artifact_sync_estimate_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/checkCacheRuleArtifactSyncEstimate"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url(
            "resource_group_name", resource_group_name, "str", max_length=90, min_length=1
...
def build_cache_rules_sync_cache_rule_request(  # pylint: disable=name-too-long
    resource_group_name: str, registry_name: str, cache_rule_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/cacheRules/{cacheRuleName}/sync"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url(
            "resource_group_name", resource_group_name, "str", max_length=90, min_length=1
...
class RegistriesOperations:
    ...
    @overload
    def check_cache_rule_artifact_sync_estimate(
        self,
        resource_group_name: str,
        registry_name: str,
        cache_rule_parameters: _models.CacheRule,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.CacheRuleArtifactSyncEstimateResult:
        """Checks the contents of an upstream repository and executes the query of a cache rule's artifact
        sync scope filter.
        ...
        :param registry_name: The name of the container registry. Required.
        :type registry_name: str
        :param cache_rule_parameters: The cache rule resource. Required.
        :type cache_rule_parameters: ~container_registry_management_client.models.CacheRule
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: CacheRuleArtifactSyncEstimateResult
        :rtype: ~container_registry_management_client.models.CacheRuleArtifactSyncEstimateResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def check_cache_rule_artifact_sync_estimate(
        ...
        resource_group_name: str,
        registry_name: str,
        cache_rule_parameters: IO[bytes],
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.CacheRuleArtifactSyncEstimateResult:
        ...
        :type registry_name: str
        :param cache_rule_parameters: The cache rule resource. Required.
        :type cache_rule_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: CacheRuleArtifactSyncEstimateResult
    ...
    def check_cache_rule_artifact_sync_estimate(
        ...
        resource_group_name: str,
        registry_name: str,
        cache_rule_parameters: Union[_models.CacheRule, IO[bytes]],
        **kwargs: Any
    ) -> _models.CacheRuleArtifactSyncEstimateResult:
        """Checks the contents of an upstream repository and executes the query of a cache rule's artifact
        sync scope filter.
        ...
        :param registry_name: The name of the container registry. Required.
        :type registry_name: str
        :param cache_rule_parameters: The cache rule resource. Is either a CacheRule type or a
         IO[bytes] type. Required.
        :type cache_rule_parameters: ~container_registry_management_client.models.CacheRule or
         IO[bytes]
        :return: CacheRuleArtifactSyncEstimateResult
        :rtype: ~container_registry_management_client.models.CacheRuleArtifactSyncEstimateResult
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.CacheRuleArtifactSyncEstimateResult] = kwargs.pop("cls", None)

        content_type = content_type or "application/json"
        _json = None
        _content = None
        if isinstance(cache_rule_parameters, (IOBase, bytes)):
            _content = cache_rule_parameters
        else:
            _json = self._serialize.body(cache_rule_parameters, "CacheRule")

        _request = build_registries_check_cache_rule_artifact_sync_estimate_request(
            resource_group_name=resource_group_name,
            registry_name=registry_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
        ...
        deserialized = self._deserialize("CacheRuleArtifactSyncEstimateResult", pipeline_response.http_response)
...
class CacheRulesOperations:
    ...
    def sync_cache_rule(
        ...
        registry_name: str,
        cache_rule_name: str,
        sync_tag_parameters: _models.CacheRuleSyncParameters,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> None:
        ...
        :param cache_rule_name: The name of the cache rule. Required.
        :type cache_rule_name: str
        :param sync_tag_parameters: Required.
        :type sync_tag_parameters: ~container_registry_management_client.models.CacheRuleSyncParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    def sync_cache_rule(
        ...
        **kwargs: Any
        ...
        :type cache_rule_name: str
        :param sync_tag_parameters: Required.
        :type sync_tag_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    @distributed_trace
    def sync_cache_rule(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        registry_name: str,
        cache_rule_name: str,
        sync_tag_parameters: Union[_models.CacheRuleSyncParameters, IO[bytes]],
        **kwargs: Any
    ) -> None:
        """sync_cache_rule.
        ...
        :param cache_rule_name: The name of the cache rule. Required.
        :type cache_rule_name: str
        :param sync_tag_parameters: Is either a CacheRuleSyncParameters type or a IO[bytes] type.
         Required.
        :type sync_tag_parameters: ~container_registry_management_client.models.CacheRuleSyncParameters
         or IO[bytes]
        :return: None
        ...
        _json = None
        _content = None
        if isinstance(sync_tag_parameters, (IOBase, bytes)):
            _content = sync_tag_parameters
        else:
            _json = self._serialize.body(sync_tag_parameters, "CacheRuleSyncParameters")

        _request = build_cache_rules_sync_cache_rule_request(
            resource_group_name=resource_group_name,
            registry_name=registry_name,
            cache_rule_name=cache_rule_name,
            subscription_id=self._config.subscription_id,
