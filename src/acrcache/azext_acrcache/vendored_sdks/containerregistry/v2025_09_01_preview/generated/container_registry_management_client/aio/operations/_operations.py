...
from ...operations._operations import (
    ...
    build_cache_rules_sync_cache_rule_request,
    ...
    build_registries_check_cache_rule_artifact_sync_estimate_request,
...
class RegistriesOperations:
    ...
    @overload
    async def check_cache_rule_artifact_sync_estimate(
        self,
        resource_group_name: str,
        registry_name: str,
